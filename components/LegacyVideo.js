  ...
  return (
    <div className="relative group max-w-[320px] mx-auto">
      ...
      <a 
        ...
        className="relative block aspect-[9/16] w-full overflow-hidden border border-white/10 rounded-xl bg-secondary shadow-2xl transition-transform duration-500 group-hover:scale-[1.02]"
      >
        {/* Thumbnail Image */}
        <img
          src={thumbnail}
